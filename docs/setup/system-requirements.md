...
* 128 MB of RAM, MINIMUM. The map server in an idle state consumes about 76MB of RAM, depending on how many maps and [NPCs](../basics/npc.md) are loaded (41mb when no NPCs are in use).
